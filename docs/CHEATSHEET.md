...
**One-page cheatsheet for fast development** | Version 2.46.0
...
### 5. **Multilingual & Read-Only (v2.13.0+)**
```yaml
# Nested format (recommended)
title: {ru: "Название", uk: "Назва", en: "Name"}
...
**Last updated:** 2025-12-05 | **Version:** 2.46.0

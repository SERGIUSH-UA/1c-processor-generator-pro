...
Процедура СоздатьПроект(Команда)
	...
	// Витягуємо ім'я обробки з ЭтаФорма.ИмяФормы (формат: "ВнешняяОбработка.ИмяОбработки.Форма.ИмяФормы")
	ЧастиИмени = СтрРазделить(ЭтаФорма.ИмяФормы, ".");
	ИмяОбработки = ЧастиИмени[1]; // "УправлениеПроектами"
	ОткрытьФорму(
		"ВнешняяОбработка." + ИмяОбработки + ".Форма.КарточкаПроекта",
		ПараметрыФормы,
		ЭтаФорма,
		,
		,
...
Процедура СоздатьЗадачу(Команда)
	...
	ИмяОбработки = ЧастиИмени[1];
	ОткрытьФорму(
		"ВнешняяОбработка." + ИмяОбработки + ".Форма.КарточкаЗадачи",
		ПараметрыФормы,
		ЭтаФорма,
		,
		,
...
Процедура СформироватьОтчет(Команда)
	...
	ИмяОбработки = ЧастиИмени[1];
	ОткрытьФорму(
		"ВнешняяОбработка." + ИмяОбработки + ".Форма.ФормаОтчетов",
...
Процедура ОткрытьНастройки(Команда)
	...
	ИмяОбработки = ЧастиИмени[1];
	ОткрытьФорму(
		"ВнешняяОбработка." + ИмяОбработки + ".Форма.ФормаНастроек",
		Новый Структура("ИмяОсновнойФормы", ЭтаФорма.ИмяФормы),
		ЭтаФорма,
		,
		,
...
&НаКлиенте
Процедура ПослеЗакрытияКарточкиПроекта(РезультатЗакрытия, ДополнительныеПараметры)
 Экспорт
...
&НаКлиенте
Процедура ПослеЗакрытияКарточкиЗадачи(РезультатЗакрытия, ДополнительныеПараметры)
 Экспорт
	Если РезультатЗакрытия <> Неопределено И РезультатЗакрытия.Свойство("Сохранено") И РезультатЗакрытия.Сохранено Тогда
...
&НаКлиенте
Процедура ПослеЗакрытияНастроек(РезультатЗакрытия, ДополнительныеПараметры)
 Экспорт
	Если РезультатЗакрытия <> Неопределено И РезультатЗакрытия.Свойство("Сохранено") И РезультатЗакрытия.Сохранено Тогда
